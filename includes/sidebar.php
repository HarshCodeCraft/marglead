...
<aside class="sidebar">
    ...
    <div class="sidebar-header">
        <a href="index.php" class="sidebar-brand">
            ...
            <span><?php echo $is_tenant_session ? htmlspecialchars($tenant_company_display) : APP_NAME; ?></span>
        </a>
    </div>

    <!-- Navigation Menu Items -->
    <div class="sidebar-menu">
        <?php if ($is_tenant_session): ?>
            <!-- ================= DYNAMIC TENANT CLIENT NAVIGATION ================= -->
            <?php 
            $can_ws_dash = hasAccess('workspace_dashboard', $role);
            $can_wa_dash = hasAccess('whatsapp_dashboard', $role);
            ?>
            <?php if ($can_ws_dash || $can_wa_dash): ?>
            <div class="menu-group-title">Overview & Dashboard</div>
            <ul>
                <?php if ($can_ws_dash && $can_wa_dash): ?>
                    <!-- Both enabled: Single unified Dashboard entry in sidebar with both tabs inside the page -->
                    <li class="sidebar-item <?php echo (isActivePage('dashboard') || isActivePage('workspace_dashboard') || isActivePage('whatsapp_dashboard')) ? 'active' : ''; ?>">
                        <a href="index.php?page=dashboard">
                            <i data-lucide="layout-dashboard" style="width: 18px; height: 18px; color: var(--primary);"></i>
                            <span>Dashboard</span>
                            <span class="badge" style="margin-left: auto; background: #10b981; color: white; font-size: 0.65rem; padding: 2px 6px; border-radius: 4px;">HUB</span>
                        </a>
                    </li>
                <?php elseif ($can_ws_dash): ?>
                    <!-- Only Workspace Dashboard enabled -->
                    <li class="sidebar-item <?php echo (isActivePage('dashboard') || isActivePage('workspace_dashboard')) ? 'active' : ''; ?>">
                        <a href="index.php?page=dashboard">
                            <i data-lucide="layout-dashboard" style="width: 18px; height: 18px; color: var(--primary);"></i>
                            <span>Workspace Dashboard</span>
                        </a>
                    </li>
                <?php elseif ($can_wa_dash): ?>
                    <!-- Only WhatsApp Hub enabled -->
                    <li class="sidebar-item <?php echo (isActivePage('dashboard') || isActivePage('whatsapp_dashboard')) ? 'active' : ''; ?>">
                        <a href="index.php?page=dashboard">
                            <i data-lucide="message-square-dashed" style="width: 18px; height: 18px; color: #10b981;"></i>
                            <span>WhatsApp Hub</span>
                            <span class="badge" style="margin-left: auto; background: #10b981; color: white; font-size: 0.65rem; padding: 2px 6px; border-radius: 4px;">LIVE</span>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
            ...
            <?php if (hasAccess('leads', $role) || hasAccess('clients', $role) || hasAccess('customer_kyc', $role) || hasAccess('pipeline', $role) || hasAccess('followups', $role)): ?>
                ...
                <ul>
                    ...
                    <?php endif; ?>
                    <?php if (hasAccess('customer_kyc', $role)): ?>
            ...
            <?php if (hasAccess('installation', $role) || hasAccess('training', $role) || hasAccess('support', $role) || hasAccess('renewals', $role)): ?>
                <div class="menu-group-title">Operations & Support</div>
                <ul>
            ...
            <!-- WhatsApp & Messaging -->
            <?php if (hasAccess('merchant_waba_settings', $role) || hasAccess('whatsapp_settings', $role) || hasAccess('team_inbox', $role) || hasAccess('broadcast_campaigns', $role) || hasAccess('bulk_broadcast', $role) || hasAccess('bot_flows', $role) || hasAccess('whatsapp_flows', $role)): ?>
                ...
                <ul>
                    <?php if (hasAccess('merchant_waba_settings', $role) || hasAccess('whatsapp_settings', $role)): ?>
                        <li class="sidebar-item <?php echo (isActivePage('merchant_waba_settings') || isActivePage('whatsapp_settings')) ? 'active' : ''; ?>">
                            <a href="index.php?page=merchant_waba_settings">
                                <i data-lucide="qr-code" style="width: 18px; height: 18px; color: #10b981;"></i>
                                <span>Marg WABA Setup & QR</span>
                                <span class="badge" style="margin-left: auto; background: #10b981; color: white; font-size: 0.65rem; padding: 2px 6px; border-radius: 4px;">GATEWAY</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (hasAccess('team_inbox', $role)): ?>
                        <li class="sidebar-item <?php echo isActivePage('team_inbox') ? 'active' : ''; ?>">
                    ...
                    <?php if (hasAccess('broadcast_campaigns', $role) || hasAccess('bulk_broadcast', $role)): ?>
                        <li class="sidebar-item <?php echo (isActivePage('broadcast_campaigns') || isActivePage('bulk_broadcast')) ? 'active' : ''; ?>">
                            <a href="index.php?page=broadcast_campaigns">
                                <i data-lucide="send" style="width: 18px; height: 18px; color: #8b5cf6;"></i>
                                <span>WhatsApp Campaigns</span>
                                <span class="badge" style="margin-left: auto; background: #3b82f6; color: white; font-size: 0.65rem; padding: 2px 6px; border-radius: 4px;">NEW</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (hasAccess('bot_flows', $role) || hasAccess('whatsapp_flows', $role)): ?>
                        <li class="sidebar-item <?php echo (isActivePage('bot_flows') || isActivePage('bot_flow_builder')) ? 'active' : ''; ?>">
                            <a href="index.php?page=bot_flows">
                                <i data-lucide="bot" style="width: 18px; height: 18px; color: #06b6d4;"></i>
                                <span>Bots & Auto-Reply</span>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
            ...
            <!-- Analytics & Settings -->
            <?php if (hasAccess('reports', $role) || hasAccess('settings', $role)): ?>
                <div class="menu-group-title">Analytics & Config</div>
                <ul>
            ...
            <?php if (hasAccess('privacy_policy', $role) || hasAccess('terms_conditions', $role)): ?>
            <div class="menu-group-title">Legal & Support</div>
            <ul>
                <?php if (hasAccess('privacy_policy', $role)): ?>
                ...
                <?php endif; ?>
                <?php if (hasAccess('terms_conditions', $role)): ?>
        ...
        <?php if (hasAccess('team_inbox', $role) || hasAccess('broadcast_campaigns', $role) || hasAccess('merchant_waba_settings', $role) || hasAccess('whatsapp_settings', $role) || hasAccess('bulk_broadcast', $role) || hasAccess('bot_flows', $role) || hasAccess('whatsapp_flows', $role)): ?>
            ...
            <ul>
                ...
                <?php if (hasAccess('broadcast_campaigns', $role) || hasAccess('bulk_broadcast', $role)): ?>
                    <li class="sidebar-item <?php echo (isActivePage('broadcast_campaigns') || isActivePage('bulk_broadcast')); ?>">
                        <a href="index.php?page=broadcast_campaigns">
