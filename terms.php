<?php
/**
 * Friendly AI Solution - Terms of Use & Continuation Policy
...
$policy_points = get_policy_points('terms', true);
...
<head>
    ...
    <title>Terms of Use & Continuation Policy | Friendly AI Solution</title>
    <meta name="description" content="Terms of Use and Service Continuation Policy for Friendly AI Solution - Official Marg ERP 9+ automation and Meta WhatsApp Cloud API suite.">
    <meta name="keywords" content="Friendly AI Solution Terms of Use, Marg ERP Integration Policy, WhatsApp Cloud API Terms, Continuation Policy">
...
<body>
    ...
    <div class="policy-breadcrumb-bar">
        <div class="policy-breadcrumb-container">
            ...
            <span>Policies</span>
            <span class="policy-breadcrumb-sep">/</span>
            <span style="color: #212121; font-weight: 600;">Terms of Use</span>
        </div>
    </div>
    ...
    <main class="policy-main-container">
        ...
        <aside class="policy-sidebar">
            ...
            <ul class="policy-sidebar-nav">
                <li class="policy-sidebar-item">
                    <a href="terms.php" class="policy-sidebar-link active">
        ...
        <article class="policy-document-card">
            ...
            <h1 class="doc-title">Terms of Use & Continuation Policy</h1>
            
            <div class="doc-meta">
                <div>
                    <span>Last Updated: <strong><?php echo $last_updated_date; ?></strong></span>
                    <span style="margin: 0 0.5rem;">•</span>
                    <span>Applicable to: <strong>Marg ERP 9+ Middleware & WhatsApp Cloud API</strong></span>
                </div>
            </div>

            <div class="doc-preamble">
                Please read the following terms and conditions carefully before subscribing to, accessing, or utilizing the <strong>Friendly AI Solution</strong> platform, Marg ERP 9+ Desktop Connector Bridge, or Meta WhatsApp Business API relays. By using our website or subscribing to our services, you expressly acknowledge and agree to be governed by the terms set forth herein.
            </div>
            ...
            <div class="doc-grievance-box" id="grievance-officer">
                ...
                <p style="margin-bottom: 0.5rem;">
                    In accordance with the Information Technology Act, 2000 and the Consumer Protection (E-Commerce) Rules, 2020, the contact details of the Grievance Officer and Corporate Operations Desk are published below:
                </p>
